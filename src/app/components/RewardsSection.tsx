  ...
  return (
    ...
    >
      <div className='flex flex-col gap-6'>
        ...
        <p className='text-h3 max-w-[860px] text-text-primary'>
      ...
      <div className='grid grid-cols-2 gap-6'>
        <div className='relative flex h-[450px] flex-col rounded-xl bg-background-component p-8'>
          <h3 className='text-lg-medium max-w-[428px] text-text-primary'>
          ...
          <div className='absolute bottom-10 left-10 right-10'>
            ...
            />
            <img
              className='animate-swing absolute -right-6 bottom-4 h-16'
        ...
        <div className='relative flex h-[450px] flex-col gap-3 rounded-xl bg-background-component p-8'>
          ...
          <div className='absolute bottom-10 left-10 right-10'>
            ...
            />
            <img
              className='animate-swing absolute -right-4 bottom-4 h-20'
